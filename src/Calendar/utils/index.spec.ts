...
describe('generateCalendar', () => {
  ...
  it('returns an array with the current month', () => {
    ...
    expect(response[0].toISOString()).toContain('2020-05-31');
    expect(response[15].toISOString()).toContain('2020-06');
    expect(response[34].toISOString()).toContain('2020-07-04');
  });
});
...
describe('generateWeekCalendar', () => {
  ...
  it('returns an array with the current week', () => {
    ...
    expect(response[0].toISOString()).toContain('2020-06-07');
    expect(response[1].toISOString()).toContain('2020-06-08');
    expect(response[2].toISOString()).toContain('2020-06-09');
    expect(response[3].toISOString()).toContain('2020-06-10');
    expect(response[4].toISOString()).toContain('2020-06-11');
    expect(response[5].toISOString()).toContain('2020-06-12');
    expect(response[6].toISOString()).toContain('2020-06-13');
  });
});
